...
const STORAGE_KEY = "alaska_trip_2026_v3";
const TRAVELERS = 2;
...
const DEFAULT_ITEMS = [
  // ---------- FLIGHTS ----------
  { id: "fl-in", name: "Flight home → Anchorage (ANC)", date: "2026-08-09", start: "", end: "22:32",
    location: "Ted Stevens Anchorage Intl", area: "Anchorage", category: "Flight", budgetCat: "Flights",
    status: "Booked", priority: "Must Do", decision: "Keep", cost: 950, placeholder: true, paid: true,
  ...
  { id: "fl-out", name: "Flight Anchorage (ANC) → home", date: "2026-08-16", start: "06:15", end: "",
    location: "Ted Stevens Anchorage Intl", area: "Anchorage", category: "Flight", budgetCat: "Flights",
    status: "Booked", priority: "Must Do", decision: "Keep", cost: 0, paid: true,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
    notes: "6:15 AM departure — leave hotel by ~4:15 AM. Cost included in round-trip fare above." },

  // ---------- RENTAL CAR ----------
  { id: "car", name: "Rental car — AWD / compact SUV (e.g. Hyundai Kona AWD)", date: "2026-08-09", start: "23:00", end: "",
    location: "ANC airport rental center", area: "Anchorage", category: "Admin", budgetCat: "Rental car",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 800, placeholder: true, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
  ...
  { id: "lg-0809", name: "Airport-area hotel — Anchorage", date: "2026-08-09", start: "23:15", end: "",
  ...
  { id: "lg-0810", name: "Palmer / Wasilla lodging", date: "2026-08-10", start: "", end: "",
    location: "Palmer or Wasilla", area: "Mat-Su Valley", category: "Lodging", budgetCat: "Lodging",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 160, placeholder: true, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
    notes: "Close to Knik helicopter base for Tuesday morning. Placeholder rate." },
  { id: "lg-0811", name: "Seward lodging — night 1", date: "2026-08-11", start: "", end: "",
    location: "Seward", area: "Kenai Peninsula", category: "Lodging", budgetCat: "Lodging",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 220, placeholder: true, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
    notes: "Book 2 nights (Aug 11–12) if the same property works. Placeholder rate." },
  { id: "lg-0812", name: "Seward lodging — night 2", date: "2026-08-12", start: "", end: "",
    location: "Seward", area: "Kenai Peninsula", category: "Lodging", budgetCat: "Lodging",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 220, placeholder: true, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
    notes: "Easy evening after Harding Icefield. Placeholder rate." },
  { id: "lg-0813", name: "Homer lodging — night 1", date: "2026-08-13", start: "", end: "",
    location: "Homer", area: "Kenai Peninsula", category: "Lodging", budgetCat: "Lodging",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 200, placeholder: true, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "High",
    notes: "Spit-adjacent if possible. Placeholder rate." },
  { id: "lg-0814", name: "Homer / Soldotna / Cooper Landing lodging — night 2", date: "2026-08-14", start: "", end: "",
  ...
  { id: "tr-knik", name: "Knik Glacier helicopter landing", date: "2026-08-11", start: "09:00", end: "11:00",
    ...
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 1300, paid: false,
    link: "", conf: "", cancelBy: "", weather: true, intensity: "Low", routeFit: "High",
  ...
  { id: "tr-fjords", name: "Kenai Fjords NP boat tour (6 hr)", date: "2026-08-13", start: "08:30", end: "14:30",
    location: "Seward small boat harbor", area: "Seward", category: "Tour", budgetCat: "Tours",
    status: "Need to Book", priority: "Must Do", decision: "Keep", cost: 400, paid: false,
    link: "", conf: "", cancelBy: "", weather: true, intensity: "Low", routeFit: "High",
  ...
  // ---------- MAYBE (comparison board) ----------
  { id: "op-fish", name: "Homer half-day halibut fishing", date: "2026-08-14", start: "07:00", end: "12:00",
    location: "Homer harbor", area: "Homer", category: "Tour", budgetCat: "Optional",
    status: "Idea", priority: "Strong Maybe", decision: "Maybe", cost: 600, paid: false,
  ...
  { id: "op-sled", name: "Dog sledding (summer cart ride)", date: null, start: "", end: "",
    ...
    status: "Idea", priority: "Optional", decision: "Maybe", cost: 180, paid: false,
    link: "", conf: "", cancelBy: "", weather: false, intensity: "Low", routeFit: "Medium",
  ...
  // ---------- PASS (kept on the board, out of the itinerary) ----------
